                        ...
                        for center in resp_json["centers"]:
                            ...
                            for session in center["sessions"]:
                                if (session["min_age_limit"] <= age and session["available_capacity"] > 0 ) :
                                    ...
                                    print("\n")
                                    msg.append({"Date🗓":session["date"],"CenterName🏥":center["name"],"Pincode📍":center["pincode"],"Dose1️⃣":session["available_capacity_dose1"],"Dose2️⃣":session["available_capacity_dose2"],"VaccineType💉":session["vaccine"],"Price":session["fee"]})
